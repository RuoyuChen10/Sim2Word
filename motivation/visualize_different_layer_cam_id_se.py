...
def main(args):
    ...
    recognition_net = get_network("VGGFace2-Se")
    if torch.cuda.is_available():
        recognition_net.cuda()
    recognition_net.eval()

    mkdir("./ID_cam_visual_various_layer-SeNet")
    ...
    for layer_name in layer_names:
        ...
        for image_path in image_paths:
            ...
            save_image_dir_path = "./ID_cam_visual_various_layer-SeNet/" + image_path.split("/")[-2] + "_" + image_path.split("/")[-1].split(".")[0]
