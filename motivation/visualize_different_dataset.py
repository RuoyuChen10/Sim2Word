...
def parse_args():
    ...
    parser.add_argument('--recognition-net',
                        type=str,
                        default="ArcFace-5000-reduce",
                        choices=["ArcFace-8631", "ArcFace-5000", "ArcFace-5000-reduce"],
...
def main(args):
    ...
    for image_path in image_paths:
        ...
        save_image_dir_path = os.path.join("./ID_cam_various_dataset",args.recognition_net)
