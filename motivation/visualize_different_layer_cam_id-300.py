...
def parse_args():
    ...
    parser.add_argument('--recognition-net',
                        type=str,
                        default='VGGFace2',
                        choices=["VGGFace2", "VGGFace2-Se", "ArcFace"],
...
def main(args):
    ...
    if args.recognition_net in ["VGGFace2", "VGGFace2-Se"]:
        recognition_net = get_network(args.recognition_net)
        layer_name = "layer4.2"
        root_dir = "/home/cry/data2/VGGFace2/train_align"
    elif args.recognition_net == "ArcFace":
        weight_path = os.path.join("ckpt/ArcFace-8631.pth")
        recognition_net = torch.load(weight_path)
        layer_name = "module.layer4.2"
